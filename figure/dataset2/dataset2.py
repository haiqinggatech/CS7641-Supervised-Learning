...
#     print('Tree Depth {} & Best Parameter {} & Tree Size {} & '.format(i, output_clf.best_params_['criterion'], tree_size) + table_output ) 
...
#         clf_1 = svm.SVC(kernel=kernel, max_iter=30000, gamma=gammas[i])
#         output, output_clf, table_output = crossValidateAndTest('SVM ' + kernel + ':' + str(i), clf_1, {}, trainTest, StandardScaler())
#         print('{} & {} & '.format(kernel, gammas[i]) + table_output + ' \\\\ \\hline') 